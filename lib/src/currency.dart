...
@immutable
class Currency {
  /// Creates a [Currency] instance from a JSON representation.
  ///
  /// The JSON representation follows the same format generated by the
  /// [toJson] method and allow the reconstruction of any custom currency.
  factory Currency.fromJson(Map<String, dynamic> json) => Currency.create(
  ...
  ///
  /// The JSON representation can be used to recreate this [Currency] instance
  /// using the [Currency.fromJson] factory.
